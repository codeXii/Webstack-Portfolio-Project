          ...
          <div class="row justify-content-center user-auth bg-purple">
              <div class="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
                  ...
                  <div class="card">
                      ...
                      <form method="POST" action="<?=  ROOT_URL   ?>admin/addtenant-logic.php" class="mt-5 card__form" enctype="multipart/form-data">
                        
                          <div class="form-row">
                              <div class="form-group col-md-12">
                                <label for="fullname">FullName</label>
                                <input type="text" class="mr-2 form-control" name="fullname" value="" id="fullname" placeholder="Enter tenant FullName">
                              </div>
                          ...
                          <div class="form-group ">
                              ...
                              <input type="number" class="form-control" name="phone" value="" id="phone" placeholder="Enter phone number">
                          </div>

                           <div class="form-group">
                           <label for="property" name="country">Property</label>
                           <select class="form-select mb-2 form_control text-dark" id="property" name="property">
                        ...
                        <?php endwhile; ?>
                           ...
                           <div class="form-group">
                                ...
                                <input type="file" class="mr-2 form-control" name="avatar" value="" id="picture">
                            </div>
                          ...
                          <div class="form-row">
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" class="form-control" name="nok" id="nok" placeholder="Enter name">
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="nokp"> Next Of Kin Phone No</label>
                                  <input type="text" class="form-control" name="nokp" value="" id="nokp" placeholder="Enter Phone">
                              </div>
                          </div>

                          <div class="form-group ">
                              <label for="coo">Community Of Origin</label>
                              <input type="text" class="form-control" name="coo" value="" id="coo" placeholder="Enter community">
                          </div>

                          <div class="form-row">
                              <div class="form-group col-md-6">
                                  <label for="lga">L.G.A Of Origin</label>
                                  <input type="text" class="form-control" name="lga" id="lga" placeholder="Enter L.G.A">
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="soo"> State Of Origin</label>
                                  <input type="text" class="form-control" name="soo" value="" id="soo" placeholder="Enter State Of Origin">
                              </div>
                          </div>

                          <div class="form-group">
                           <label for="apartment" name="apartment">Type Of Apartment</label>
                           <select class="form-select mb-2 form_control text-dark" id="property" name="apartment">
                                <option >Pick below</option>       
                          ...
                          <div class="form-row">
                           ...
                           <select class="form-select mb-2 form_control text-dark" id="block" name="block">
                                <option >Pick below</option>       
                           ...
                           <select class="form-select mb-2 form_control text-dark" id="hn" name="hn">
                                <option >Pick below</option>       
                                ...
                                <option value="FLAT 6">FLAT 7</option>
                                ...
                                <option value="SHOP 4">SHOP 5</option>
                          ...
                          <div class="form-row">
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="date" class="form-control" name="expire" id="expire" placeholder="Expiration date">
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="rent">Rent Amount No</label>
                                  <input type="number" class="form-control" name="rent" value="" id="rent" placeholder="Rent amount">
                              </div>
                          </div>
                          ...
                          <div class="form-row">
                              <div class="form-group col-md-6">
                                  ...
                                  <input type="text" class="form-control" name="work" id="tow" placeholder=" e.g civil service ">
                              </div>
                              <div class="form-group col-md-6">
                                  <label for="employer">Employer</label>
                                  <input type="text" class="form-control" name="employer" value="" id="employer" placeholder="">
                              </div>
                          </div>
