...
if(isset($_POST['submit'])){
    ...
    $count = filter_var($_POST['count'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);

    // fetch all tenants with corresponding property
    $tenants_sql = "SELECT * FROM tenants WHERE property LIKE '%$property%' ";
...
<div class="main-panel bg-dark">
        <div class="content bg-dark">
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <h2 class="text-{{$text}} pb-2">LIST OF TENANTS IN <?= $property ?></h2>
                </div>
                <a href="<?= ROOT_URL ?>tenants.php"   class="btn btn-primary mb-2" ><i class="fa-solid fa-angle-left"></i> Back</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9 col-stats">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title text-center">SINGLE BLOCK</h4> 
                                    <a href="<?= ROOT_URL ?>s-listing.php?property=<?= $property ?>&block=BLOCK&count=<?= $count ?>" class="btn btn-secondary btn-sm mt-2">View tenants</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-9 col-stats">
                                        <div class="numbers">
                                            <!-- <p class="card-category">Total Properties</p> -->
                                            <h4 class="card-title text-center">BLOCK A</h4> 
                                            <a href="<?= ROOT_URL ?>s-listing.php?property=<?= $property ?>&block=BLOCK A&count=<?= $count ?>" class="btn btn-secondary btn-sm mt-2">View tenants</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-9 col-stats">
                                        <div class="numbers">
                                            <!-- <p class="card-category">Total Properties</p> -->
                                            <h4 class="card-title text-center">BLOCK B</h4> 
                                            <a href="<?= ROOT_URL ?>s-listing.php?property=<?= $property ?>&block=BLOCK B&count=<?= $count ?>" class="btn btn-secondary btn-sm mt-2">View tenants</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-stats card-round bg-primary">
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-9 col-stats">
                                        <div class="numbers">
                                            <h5 class="card-title text">BLOCK C</h5> 
                                            <a href="<?= ROOT_URL ?>s-listing.php?property=<?= $property ?>&block=BLOCK C&count=<?= $count ?>" class="btn btn-secondary btn-sm mt-2">View tenants</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-stats card-round bg-primary">
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-9 col-stats">
                                        <div class="numbers">
                                            <h5 class="card-title text">BLOCK D</h5> 
                                            <a href="<?= ROOT_URL ?>s-listing.php?property=<?= $property ?>&block=BLOCK D&count=<?= $count ?>" class="btn btn-secondary btn-sm mt-2">View tenants</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
