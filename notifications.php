...
?>
    ...
    <div class="main-panel bg-dark">
        <div class="content bg-dark">
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <h3 class="text-{{$text}} pb-2"> <i class="fa-regular fa-bell"></i>  Notifications!</h3>
                </div>
				<div class="row">
					<div class="col-md-6">
				<?php if(isset($_SESSION['notification-success'])):?>
					<div class="alert alert-danger alert-dismissible fade show text-center text-success col-12" role="alert">
                ...
                <!-- Beginning of  notifications Stats  -->
                <div class="row row-card-no-pd  shadow-lg px-2">
    ...
    <?php if(mysqli_num_rows($sql_query) > 0):?>
        <?php while($notification = mysqli_fetch_assoc($sql_query)):?>
                        <tr>
                            <td><a href=""> <?= $notification['message'] ?></a></td>
                            <td>
                                <a href="<?= ROOT_URL ?>delete-nof.php?id=<?= $notification['id'] ?>" class="btn btn-sm btn-danger"> <i class="fa-solid fa-trash"></i> Delete</a>
                            </td>
                        </tr>
                <?php endwhile; ?>
    <?php else:?>
        
        <p>You have no new notifications yet!</p>

    <?php endif; ?>
                    </tbody>
                   </table>
                </div>
            <!-- End of notifications statistics -->             
    </div>
    </div>
    </div>
