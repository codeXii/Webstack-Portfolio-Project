...
// if the search submit button was clicked
if (isset($_GET['date_from']) && isset($_GET['date_to'])) {


    $date_from = filter_var($_GET['date_from'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    $date_to = filter_var($_GET['date_to'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    // die();
     ...
     // PAYMANTS QUERY
    $payment_sql = "SELECT * FROM payments WHERE date BETWEEN '$date_from' AND date '$date_to' ";
    $payment_query = mysqli_query($connect, $payment_sql);


   
    // $payment_sql = "SELECT * FROM payments ORDER BY id DESC";
    // $payment_query = mysqli_query($connect, $payment_sql);
...
?>
        ...
        <div class="content bg-dark">
            ...
            <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                    <div class="mb-1">
                    <h3 class="pb-2">Recent Payments made by tenants between <span class="text-white" ><?= $date_from ?></span>  and <span class="text-white" ><?= $date_to ?></span></h3>
                </div>
    ...
    <div id="view<?= $payment['t_id'] ?>" class="modal fade" role="dialog">
        ...
        ?>
            ...
            <p>HOUSE/FLAT/STORE NO: <strong><?= $tresult['apartment'] ?></strong></p>
