    ...
    <div class="main-panel bg-dark">
        <div class="content bg-dark">
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <h2 class="text-{{$text}} pb-2">Payments Reports!</h2>
                </div>
                <!-- Beginning of  Payments Stats  -->
                <div class="row row-card-no-pd  shadow-lg">
                    <div class="col-sm-6 mb-3">
                        <div class="card card-stats card-round bg-primary">
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-stats">
                                        <div class="">
                                            <h4 class="text-center">Total Payments Made This Year</h4> 
                        ...
                        <div class="mt-2">
                            <a href="<?= ROOT_URL ?>ypayment.php" class="text-white mx-1 mt-2">View Report</a>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card card-stats card-round bg-primary">
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-stats">
                                        <div class="">
                                            <h4 class="text-center">Total Payments Made This Month</h4> 
                                            <h5>&#8358;<?= number_format($months, 2) ?></h5>
                                        </div> 
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-2">
                            <a href="<?= ROOT_URL ?>mpayment.php" class="text-white mx-1 mt-2">View Report</a>
                        </div>
                    </div>
