...
?>
    ...
    <div class="main-panel bg-dark">
        <div class="content bg-dark">
            ...
            <!-- <button type="button" class="btn btn-success mb-2" data-toggle="modal" data-target="#print1" > <i class="fas fa-print"></i>  Print This Report</button> -->
            <a href="<?= ROOT_URL ?>p-ypayment.php" class="btn btn-success mb-2"> <i class="fas fa-print"></i> Print This Report</a>
